            ...
            public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
                ...
                holder.items.setAdapter(new RecyclerView.Adapter<ViewHolder_sublist>() {
                    ...
                    public ViewHolder_sublist onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        return new ViewHolder_sublist(inflater.inflate(R.layout.vendor_explore_sub_item_list , parent , false));
                    }

                    @Override
                    public void onBindViewHolder(@NonNull ViewHolder_sublist holder, int position) {

                        Toast.makeText(getActivity() , "Vendors in"  + vendors.get(holder.getAdapterPosition()).category +" : "+ vendors.get(holder.getAdapterPosition()).vendors.size() , Toast.LENGTH_SHORT).show();
